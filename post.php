...
<body>
    ...
    <form id="productDetailsForm" action="postDatabase.php" method="post" enctype="multipart/form-data">
        ...
        <label style="font-size: 14px;position:relative;left:10px;"  for="number">PhoneNumber</label>
        <input type="number" id="number" value="<?php echo htmlspecialchars(trim($phoneNumber)); ?>" name="number" required>

        <label for="address">Address</label>
        <textarea id="address"  maxlength="1000" name="address" required><?php echo htmlspecialchars($userAddress); ?> </textarea>
